...
const CanReclaimToken = artifacts.require('TRVLToken');
const BasicTokenMock = artifacts.require('./mocks/BasicTokenMock');

contract('CanReclaimToken - TravelBlock', function (accounts) {
  let token = null;
