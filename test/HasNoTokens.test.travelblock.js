...
const HasNoTokens = artifacts.require('TRVLToken');
const ERC223TokenMock = artifacts.require('./mocks/ERC223TokenMock');

contract('HasNoTokens - TravelBlock', function (accounts) {
